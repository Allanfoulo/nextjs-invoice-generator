-- Fix enum case sensitivity issue in trigger functions
-- The database enum uses lowercase values but triggers were checking for capitalized 'Accepted'
...
-- Recreate the auto-generation trigger function with correct enum case
...
-- Recreate the manual conversion function with correct enum case
...
SELECT 'Enum case sensitivity fix completed successfully' as message,
